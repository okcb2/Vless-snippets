...
let proxyIP = 'proxyip.cmliussss.net'; //'13.230.34.30';  // proxyIP 格式：ip、域名、ip:port、域名:port等,没填写port，默认使用443
let password = '9a61abb5-f733-4649-aa30-9e5f0cd97bd5';  // 节点UUID
